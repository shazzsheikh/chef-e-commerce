        ...
        <div className="w-[90%] md:w-[85%] mx-auto">
          <div>
            <p className="text-[#2e2f1e] text-base md:text-lg leading-[1.8] mt-6">
              ...
              have read, understood, and are bound by these Terms of Use,
              regardless of how you access or use the services. If you do not
              agree to the Terms, please do not use our services.
            </p>
            ...
            <p className="text-[#2e2f1e] text-base md:text-lg leading-[1.8] mt-6">
              GENERAL TERMS: Products and services available on the Site include
              but are not limited to private chef bookings, event catering, meal
              kits, merchandise, and culinary workshops. These may be subject to
              availability and may be modified or discontinued at any time
              without prior notice.
            </p>

            <p className="text-[#2e2f1e] text-base md:text-lg leading-[1.8] mt-6">
              All pricing listed on www.chefclought.com includes applicable
              taxes under Indian law unless specified. Delivery charges,
              packaging, and service fees may be added based on location and
              type of service.
            </p>

            <p className="text-[#2e2f1e] text-base md:text-lg leading-[1.8] mt-6">
              The User is responsible for any additional international taxes,
              customs duties, or currency exchange fees for cross-border
              services or shipments. Prices displayed are rounded and may vary
              slightly depending on currency fluctuations.
            </p>
            ...
            <p className="text-[#2e2f1e] text-base md:text-lg leading-[1.8] mt-6">
              We reserve the right to cancel or refuse any order or booking for
              any reason, including but not limited to availability,
              inaccuracies, or potential fraud.
            </p>
